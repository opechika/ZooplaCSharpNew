...
namespace Zoopla.Project.Test.Features
{
    ...
    [NUnit.Framework.DescriptionAttribute("For Sale Properties")]
    public partial class ForSalePropertiesFeature
    {
...
#line 1 "CustomerCanSearchForProperty.feature"
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Features", "For Sale Properties", "  As a customer\r\n  I want the ability to search for any properties for sale\r\n  So" +
        ...
        [NUnit.Framework.DescriptionAttribute("Customer can search for any property")]
        [NUnit.Framework.TestCaseAttribute("Manchester", "£140,000", "£250,000", "Houses", "3+", null)]
        public virtual void CustomerCanSearchForAnyProperty(string location, string minPrice, string maxPrice, string property, string bedroom, string[] exampleTags)
        {
            ...
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Customer can search for any property", null, tagsOfScenario, argumentsOfScenario);
#line 7
